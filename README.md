...
目前已支持识别：`✅百度网盘` `✅阿里云盘` `✅夸克网盘` `✅腾讯微云` `✅蓝奏云` `✅蓝奏云·优享版` `✅123云盘新域名` `✅4275极速文件中转站` `✅三大通信运营商网盘：中国移动(和彩云)、中国联通(沃盘)、中国电信(天翼云盘)` `✅迅雷云盘` `✅360云盘(屏蔽)` `✅115网盘` `✅奶牛快传` `✅城通网盘` `✅FlowUs息流` `✅商店类：Chrome 扩展商店、Edge 扩展商店、Firefox 扩展商店、Windows 应用商店
（安装成功后可以使用页尾的链接进行测试）**识别速度小于 1 毫秒**。

## ✍ 开发说明
本项目基于原项目 "网盘智能识别助手By youxiaohou" 项目接续开发维护
...
**v2025-7-21** 重新更新剔除整理部分已失效的网盘域名并适度添加一些口碑还不错的网盘域名，综合为一个新版本号
...
如果您在使用过程中有无法识别的文本，请 [点击这里](https://github.com/Magiclyan/panAI/issues) 进行反馈。
